...
public class BallController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        var spaceBarDownTree = new Tree<BallController>
        (
            new Sequence<BallController>
            (
        ...
        _tree = new BehaviorTree.Tree<BallController>
        (
            new Selector<BallController>
            (
                mouseDownTree,
    ...
    public void Shake()
    {
        var jitter = (speed * Random.insideUnitSphere);
        jitter.z = 0;
    ...
    public void GoTowardsMouse(bool towards)
    {
        ...
        if (towards)
        {
            transform.position -= speed * vectorTowardsMouse;
        }
        else
        {
            transform.position += speed * vectorTowardsMouse;
